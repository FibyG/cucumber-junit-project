    ...
    public static WebDriver getDriver() {
        ...
        if (driverPool.get() == null) {  // if driver/browser was never opened
            ...
            if (System.getProperty("BROWSER") == null) {
                browserType = ConfigurationReader.getProperty("browser");// local browser
            } else {
                browserType = System.getProperty("BROWSER"); // remote browser
            }
            ...
            switch (browserType) {
                case "remote-chrome":
                    try {
                        ...
                        String gridAddress = "54.221.151.223";
